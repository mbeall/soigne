		...
		<header class="entry-header">
			<?php if ( is_sticky() ) : ?>
				<hgroup>
					...
					<h3 class="entry-format"><?php _e( 'Featured', 'soigne' ); ?></h3>
				</hgroup>
			<?php else : ?>
			<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'soigne' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
			<?php endif; ?>
