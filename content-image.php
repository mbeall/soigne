	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'indexed' ); ?>>
		<header class="entry-header">
			<hgroup>
				...
				<h3 class="entry-format"><?php _e( 'Image', 'soigne' ); ?></h3>
			</hgroup>
		...
		<footer class="entry-meta">
			<div class="entry-meta">
				<?php
					printf( __( '<a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" pubdate>%3$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>', 'soigne' ),
			...
			<div class="entry-meta">
				...
				<span class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply', 'soigne' ) . '</span>', __( '<strong>1</strong> Reply', 'soigne' ), __( '<strong>%</strong> Replies', 'soigne' ) ); ?></span>
